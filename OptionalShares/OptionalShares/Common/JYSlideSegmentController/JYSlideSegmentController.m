...
- (UICollectionView *)segmentBar
{
  if (!_segmentBar) {
    ...
    _segmentBar.backgroundColor = [UIColor colorWithPatternImage:image];
...
- (UIView *)indicator
{
  if (!_indicator) {
    ...
    _indicator.backgroundColor = [UIColor colorWithRed:48/255.0 green:96/255.0 blue:169/255.0 alpha:1.0];
  }
  return _indicator;
}
